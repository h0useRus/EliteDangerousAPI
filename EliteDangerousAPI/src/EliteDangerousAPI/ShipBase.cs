    ...
    public class ShipBase
    {
        ...
        public static readonly ShipBase Adder
            = new ShipBase(ShipModel.Adder)
            {
                ...
                Name = "Adder",
                Manufacture = "Zorgon Peterson",
                Class = ShipClass.Small,
                Cost = 18710,
                Retail = 87810,
                ThrustersSpeed = 220,
                BoostSpeed = 320,
        ...
        public static readonly ShipBase Anaconda
            = new ShipBase(ShipModel.Anaconda)
            {
                ...
                ShipRole = ShipRole.Multipurpose,
                Name = "Anaconda",
                Manufacture = "Faulcon DeLacy",
                Class = ShipClass.Large,
                Cost = 142447820,
                Retail = 146969450,
                ThrustersSpeed = 180,
                BoostSpeed = 240,
